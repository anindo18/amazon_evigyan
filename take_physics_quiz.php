...
<li><a href="close_physics_quiz.php">Abort this quiz</a></li>
<li><a href="intro1.html">Go to Chapters</a></li>
...
<html>
    ...
    <body>
        <form name="form" action="take_physicsquiz_next.php" method="post">
            <?php
            ...
            $_SESSION['views_phy_quiz']=1;
            echo "Number of questions attempted is :". $_SESSION['views_phy_quiz']."<br>";
            if( $_SESSION['views_phy_quiz']>10)
            {
        ...
        $result1 = mysqli_query($con,"select * FROM quiz_physics");
...
echo "Total rows: " . $num_rows."<br>";
        ...
        //echo($random1)."<br/>";
         ...
         $count1 = $random1;
  $result = mysqli_query($con,"SELECT id, question, option1, option2, option3,option4,answer FROM quiz_physics where id=$random1");
