...
table tr:hover td{
    ...
    <body background="table.jpg">
        ...
        echo "<center>";
       echo "<div>";
        echo "<h1><font color='aqua'> HI ".$_COOKIE["user"]." SEE YOUR BIOLOGY SCORE </font></h1>";
       echo "</div>";
        echo "</center>";
        $user=$_COOKIE["user"];
...
$result = mysqli_query($con,"SELECT * FROM user_bio_score where username='$user'");
