...
$count3=0;
        ...
        {
            session_start();
            if(isset($_SESSION['viewsc']))
            $_SESSION['viewsc']=$_SESSION['viewsc']+1;
            else
            $_SESSION['viewsc']=1;
            echo "Number of correct answer is :". $_SESSION['viewsc']."<br>";
            echo "Correct answer";
            $count3++;  
       ...
       <input type="button" name="gotolgpg" value="close this quiz" onclick="gotologin_pg();">
        ...
        <script language="javascript">
            function gotonext()
            {
                ...
                window.location="take_quiz_chem.php";
            }
            function gotologin_pg()
            {
                
                window.location="close_physics_quiz.php";
            }
        </script>
