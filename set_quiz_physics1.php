...
.styled-button-5 {
    ...
    <body background="bg.jpg">
        ...
        <center>
        <div>
        <!--<h1><font color="blue"> ADMIN PAGE</h1></font>-->
        <h1><font color="aqua" size="13"> STORE PHYSICS QUESTION</h1></font>
        ...
        if (isset($_POST["ques"]) && isset($_POST["option1"]) && isset($_POST["option2"]) && isset($_POST["option3"]) && isset($_POST["option4"]))
       {
           ...
           if (mysqli_connect_errno())
            ...
            $query = "SELECT COUNT(*) FROM quiz_physics WHERE question='$_POST[ques]'";
           ...
           // if ($row["COUNT(*)"] != 0) 
            ...
            else 
            {
             ...
             $query = "INSERT INTO quiz_physics (question,option1,option2,option3,option4,answer) VALUES ('$_POST[ques]','$_POST[option1]', '$_POST[option2]', '$_POST[option3]', '$_POST[option4]', '$_POST[answer]')";
