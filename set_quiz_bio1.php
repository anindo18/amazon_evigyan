...
<li><a href="adminnext.php">Go to Main Menu</a></li>
...
.styled-button-5 {
    ...
    <body background="bg.jpg">
        ...
        <?php
        echo "<p style='position: relative; left: 200px'><b><i><a href='admin_info.php'><font color='white'>".$_COOKIE["admin"]."</font></a></i></b></p>" ;?>
        <hr>
        <br>
    ...
    <center>
        <div>
        <h1><font color="aqua" size="13">STORE BIOLOGY QUESTION</font></h1>
        <form action="<?php $_SERVER["PHP_SELF"]?>" method="post">
            <font color="white"><b>QUESTION:</b></font><br> <textarea rows="10" cols="50" name="ques"></textarea><br><br>
       <font color="white" size="5"><b>OPTION 1:</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="option1"><br><br>
       <font color="white" size="5"><b>OPTION 2:</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="option2"><br><br>
       <font color="white" size="5"><b>OPTION 3:</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="option3"><br><br>
       <font color="white" size="5"><b>OPTION 4:</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="option4"><br><br>
       <font color="white" size="5"><b>ANSWER :</b></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="answer"><br><br>
        ...
        if (isset($_POST["ques"]) && isset($_POST["option1"]) && isset($_POST["option2"]) && isset($_POST["option3"]) && isset($_POST["option4"]))
       {
           ...
           if (mysqli_connect_errno())
            ...
            $query = "SELECT COUNT(*) FROM quiz_biology WHERE question='$_POST[ques]'";
           ...
           // if ($row["COUNT(*)"] != 0) 
            ...
            else 
            {
             ...
             $query = "INSERT INTO quiz_biology (question,option1,option2,option3,option4,answer) VALUES ('$_POST[ques]','$_POST[option1]', '$_POST[option2]', '$_POST[option3]', '$_POST[option4]', '$_POST[answer]')";
