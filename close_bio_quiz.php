...
if (mysqli_connect_errno())
  ...
  $corr_ans= $_SESSION['viewsb'];
  echo "<h1>The correct answer is ".$corr_ans."</h1><br>";
  $attempt_ques=$_SESSION['views_bio_quiz'];
 ...
 $sql="INSERT INTO user_bio_score VALUES('$user','$date1','$corr_ans','$attempt_ques')";
...
mysqli_close($con);
  ...
  print '<script type="text/javascript">'; 
        ...
        unset($_SESSION['viewsb']);
        
        if(isset($_SESSION['views_bio_quiz']))
        unset($_SESSION['views_bio_quiz']);
